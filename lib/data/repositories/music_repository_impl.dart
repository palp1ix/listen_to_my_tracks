...
class MusicRepositoryImpl implements MusicRepository {
  ...
  @override
  Future<Result<List<TrackEntity>, AppException>> getArtistTracks(int artistId) async {
    try {
      // 1. Fetch data models from the remote data source.
      final trackModels = await _remoteDataSource.getArtistTracks(artistId: artistId);
