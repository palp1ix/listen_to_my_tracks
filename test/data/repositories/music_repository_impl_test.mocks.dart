...
// in listen_to_my_tracks/test/data/repositories/music_repository_impl_test.dart.
...
import 'package:listen_to_my_tracks/data/datasources/music_remote_datasource.dart'
    as _i2;
import 'package:listen_to_my_tracks/data/models/track/track_model.dart' as _i4;
...
class MockMusicRemoteDataSource extends _i1.Mock
    implements _i2.MusicRemoteDataSource {
  MockMusicRemoteDataSource() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i3.Future<List<_i4.TrackModel>> searchTracks({required String? query}) =>
      (super.noSuchMethod(
